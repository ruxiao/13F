...
BUY_THRESHOLD = 0.2 # Example: Buy if score is positive (adjust based on score distribution)
SELL_THRESHOLD = -0.1 # Example: Sell if score turns slightly negative or drops
